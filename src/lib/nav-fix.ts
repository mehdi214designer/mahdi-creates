...
/**
 * Injects the exact home page footer (HTML + component CSS) into static blog/case-study pages.
 * Framer's static export only has 3 desktop SSR variants — no mobile breakpoint. The footer
 * component CSS (framer-N2qEu, framer-HhURt) is extracted from the live mahdicreates.framer.ai
 * home page. A tiny JS snippet applies framer-v-1muf1nr at viewport ≤ 809px to activate the
 * Framer mobile layout rules, matching the home page exactly.
